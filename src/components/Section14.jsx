...
function Section14(){
    return(
        <div className="divsec flex flex-col items-center p-10 gap-5 text-white mt-2">
            ...
            <span><img src={altxt} alt="al" className=" inline" />Instant Results 
            <img src={altxt} alt="al" className=" inline-flex" />User-Friendly Interface
            <img src={altxt} alt="al" className=" inline-flex" />Personalized Customization
            </span>
        </div>
    )
}
