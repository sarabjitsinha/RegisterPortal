...
function Section1(){
    ...
    return(
        ...
        <div className="div1">
            <br />
       <p className=" text-3xl font-semibold "> Your trusted partner for compliance business needs</p>
       <br />
        <p>
        ...
        <br /><br />
            ...
            <img src={Img4} alt="" className="h-auto w-6"/>
            <div className=" flex">
        ...
        <div className=" flex p-3">
            <button className=" bg-blue-800 rounded-2xl "> Talk to an expert</button>
