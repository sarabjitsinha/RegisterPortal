    ...
    return (
        <div className="flex sec5">
           ...
           <p className=" text-4xl font-extrabold"> Why Choose Register Karo</p>
            ...
            <article className="grtst flex flex-wrap basis-[70%] w-[40%] relative left-[27%] 
            gap-5 justify-center  bg-blue-300 rounded-4xl p-3">
               <img src={sym1} alt="sym1" className="p-2"/>
                <h1 className=" text-2xl font-bold">Guaranteed Satisfaction</h1>
         ...
         <article className="  p-5 bg-amber-200  rounded-4xl h-[46%] w-[99%]">
            <img src={sym2} alt="symb2" className=" justify-self-center"/>
            <h1 className=" text-2xl font-bold">Confidential & Safe</h1>
            <p>All your private information is safe with us</p>
         </article>
         <article className=" p-5 bg-pink-200   rounded-4xl h-[46%] w-[99%]">
         <img src={sym3} alt="symb3" className=" justify-self-center"/>
            <h1 className=" text-2xl font-bold">Expert CA/CS Assistance</h1>
            <p>Prompt support from our in-house expert professionals</p>
         </article>
         </div>
         <div className=" flex flex-wrap gap-3">
         <article className="p-5 bg-purple-400 rounded-4xl h-[46%] w-[99%]">
         <img src={sym4} alt="symb4" className=" justify-self-center"/>
            <h1 className=" text-2xl font-bold">No Hidden Fee</h1>
            <p>Everything is put before you with no hidden charges or conditions</p>
         </article>
         <article className="p-5 bg-green-200 rounded-4xl h-[46%] w-[99%]">
